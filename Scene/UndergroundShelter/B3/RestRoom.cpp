...
void RestRoom::Initialize(){
    ...
    if(Shared::previousStage == "ELevatorB3") MC = new Maincharacter("MCRightStop.png", 1450, 680, 32, 200);
    else if(Shared::previousStage == "DiningRoom") MC = new Maincharacter("MCRightStop.png", 20, 680, 32, 200);
    if (!MC) {
...
void RestRoom::Draw() const{
    ...
    if(MC -> Position.x >= 1400){
        ...
        al_draw_text(PoetFont, al_map_rgb(0, 0, 0), MC -> Position.x - 310, 700, 0, "Press E to ");
        al_draw_text(PoetFont, al_map_rgb(0, 0, 0), MC -> Position.x - 310, 740, 0, "Back");
    }
