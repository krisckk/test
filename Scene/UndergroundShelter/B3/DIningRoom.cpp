...
void DiningRoom::Initialize(){
    ...
    if(Shared::previousStage == "RestRoom") MC = new Maincharacter("MCRightStop.png", 1450, 680, 32, 200);
    else if(Shared::previousStage == "GYMscene") MC = new Maincharacter("MCRightStop.png", 20, 680, 32, 200);
    if (!MC) {
